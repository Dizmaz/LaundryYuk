...
public @interface OrderPaymentUnique {
    ...
    class OrderPaymentUniqueValidator implements ConstraintValidator<OrderPaymentUnique, Long> {
        ...
        public boolean isValid(final Long value, final ConstraintValidatorContext cvContext) {
            ...
            if (currentId != null && value.equals(orderService.get(Long.parseLong(currentId)).getPayment())) {
